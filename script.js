...
var settings={
    duration : '1000',  // 1 saniyede değişsin
    random : false      
};
...
document.querySelectorAll('.arrow').forEach(function(item){   // mouse ile sağ sol tuşlarına gelince slayt dursun , çıkınca devam etsin.
...
function init(settings){    // burada ki setting ile initteki setting aynı değil.
